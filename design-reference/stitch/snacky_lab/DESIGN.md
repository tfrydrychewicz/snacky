...
- **Ambient Shadows:** When an element _must_ float (e.g., a FAB or a floating macro-summary), use a shadow with a 32px blur at 6% opacity. The shadow color must be a tint of `on_surface` (#1A1C1C), never pure black.
