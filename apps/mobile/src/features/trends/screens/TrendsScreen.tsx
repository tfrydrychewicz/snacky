      ...
      >
        ...
        <BentoTile index={0} style={{ marginBottom: spacing.lg }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'baseline', marginBottom: spacing.md }}>
            ...
            <Text style={{ ...typography.titleMd, color: colors.onSurfaceVariant, fontWeight: '500' }}>/100</Text>
          </View>
          <View
            style={{
              flexDirection: 'row',
          ...
          <Text style={{ ...typography.bodySm, color: colors.onSurfaceVariant, lineHeight: 20, maxWidth: 280 }}>
            {t('dqi_insight')}
          </Text>
          {/* Progress dots */}
        ...
        <BentoTile index={1} variant="lowest" style={{ marginBottom: spacing.lg }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: spacing.lg }}>
            ...
            <View style={{ alignItems: 'flex-end' }}>
              <Text style={{ ...typography.headlineMd }}>
                84.2 <Text style={{ ...typography.labelMd, color: colors.onSurfaceVariant, fontWeight: '500' }}>kg</Text>
              </Text>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
            {[t('week_1'), t('week_2'), t('week_3'), t('week_4')].map((w) => (
              <Text key={w} style={{ ...typography.labelSm, color: colors.onSurfaceVariant, textTransform: 'uppercase', letterSpacing: 1.5 }}>
                {w}
              </Text>
            ))}
          </View>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: spacing.md }}>
          ...
          <Pressable hitSlop={8}>
            <Text style={{ ...typography.labelMd, color: colors.primary, fontWeight: '700' }}>{t('view_all')}</Text>
          </Pressable>
        </View>
        ...
        {/* Insight Tiles */}
        <BentoTile index={5} style={{ marginBottom: spacing.lg, backgroundColor: colors.tertiaryFixed }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: spacing.md }}>
            <Text style={{ fontSize: 20 }}>🧠</Text>
            <Text style={{ ...typography.labelSm, color: colors.onTertiaryContainer, textTransform: 'uppercase', letterSpacing: 1.2 }}>
              {t('mindful_eating')}
            </Text>
          </View>
          <Text style={{ ...typography.titleLg, color: '#261A00' }}>{t('consistency', { pct: 85 })}</Text>
          <Text style={{ ...typography.bodySm, color: '#5B4300', marginTop: 4 }}>
            {t('consistency_detail')}
          </Text>
        </BentoTile>

        <BentoTile index={6} style={{ marginBottom: spacing.lg, backgroundColor: colors.secondaryFixed }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: spacing.md }}>
            ...
            >
              <Text style={{ ...typography.headlineMd, fontWeight: '800', color: '#00105C' }}>8/10</Text>
            </View>
            <View style={{ flex: 1 }}>
              <Text style={{ ...typography.titleLg, color: '#00105C' }}>{t('hydration_title')}</Text>
